...
Add these in the GitHub UI (**About → ⚙ → Topics**) so the repo surfaces in relevant searches:
...
Then create a release on GitHub (**Releases → Draft new release → pick v1.0**) and paste the "What's in v1.0" bullets above as the release notes.
